              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="card-flat p-8">
                  <button
                    ...
                    type="button"
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 mb-6 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-dark transition-colors"
                  >
